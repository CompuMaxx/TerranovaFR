...
#define BATTLE_TERRAIN_DARK_GRASS	20
#define BATTLE_TERRAIN_SNOW         11
#define BATTLE_TERRAIN_AUTUM        22
#define BATTLE_TERRAIN_GRASS_WATER	23
#define BATTLE_TERRAIN_BLAINE       24
