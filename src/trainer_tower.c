...
static const struct SinglesTrainerInfo sSingleBattleTrainerInfo[] = {
    ...
    {OBJ_EVENT_GFX_TUBER_F_LAND,        FACILITY_CLASS_TUBER,            FEMALE},
    ...
    {OBJ_EVENT_GFX_GAMER,      FACILITY_CLASS_EXPERT,           MALE},
    {OBJ_EVENT_GFX_OLD_WOMAN_1,      FACILITY_CLASS_EXPERT_2,         FEMALE},
    ...
    {OBJ_EVENT_GFX_GAMER,      FACILITY_CLASS_GAMER,            MALE},
    ...
    {OBJ_EVENT_GFX_TUBER_F_LAND,        FACILITY_CLASS_TUBER_3,          FEMALE},
...
static const struct DoublesTrainerInfo sDoubleBattleTrainerInfo[] = {
    ...
    {OBJ_EVENT_GFX_GAMER,      OBJ_EVENT_GFX_OLD_WOMAN_1,      FACILITY_CLASS_OLD_COUPLE,     MALE, FEMALE},
