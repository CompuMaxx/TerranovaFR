...
void Sunny_InitVars(void)
{
    gWeatherPtr->gammaTargetIndex = 0;
    gWeatherPtr->gammaStepDelay = 20;
    Weather_SetBlendCoeffs(10, 10); // Right parameter from 0 to 15, where lower is darker
    gWeatherPtr->noShadows = FALSE;
}
...
void Rain_InitVars(void)
{
    ...
    Weather_SetBlendCoeffs(10, 10); // preserve shadow darkness
    gWeatherPtr->noShadows = FALSE;
}
...
void FogHorizontal_Main(void)
{
    ...
    case 0:
        ...
        {
            paletteNum = IndexOfSpritePaletteTag(TAG_WEATHER_START);
