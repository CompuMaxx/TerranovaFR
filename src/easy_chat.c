...
static const u8 *const sEasyChatGroupNamePointers[] = {
    [EC_GROUP_POKEMON] = gText_EasyChatGroupName_Pokemon,
    [EC_GROUP_TRAINER] = gText_EasyChatGroupName_Trainer,
    [EC_GROUP_STATUS] = gText_EasyChatGroupName_Status,
    [EC_GROUP_BATTLE] = gText_EasyChatGroupName_Battle,
    [EC_GROUP_GREETINGS] = gText_EasyChatGroupName_Greetings,
    [EC_GROUP_PEOPLE] = gText_EasyChatGroupName_People,
    [EC_GROUP_VOICES] = gText_EasyChatGroupName_Voices,
    [EC_GROUP_SPEECH] = gText_EasyChatGroupName_Speech,
    [EC_GROUP_ENDINGS] = gText_EasyChatGroupName_Endings,
    [EC_GROUP_FEELINGS] = gText_EasyChatGroupName_Feelings,
    [EC_GROUP_CONDITIONS] = gText_EasyChatGroupName_Conditions,
    [EC_GROUP_ACTIONS] = gText_EasyChatGroupName_Actions,
    [EC_GROUP_LIFESTYLE] = gText_EasyChatGroupName_Lifestyle,
    [EC_GROUP_HOBBIES] = gText_EasyChatGroupName_Hobbies,
    [EC_GROUP_TIME] = gText_EasyChatGroupName_Time,
    [EC_GROUP_MISC] = gText_EasyChatGroupName_Misc,
    [EC_GROUP_ADJECTIVES] = gText_EasyChatGroupName_Adjectives,
    [EC_GROUP_EVENTS] = gText_EasyChatGroupName_Events,
    [EC_GROUP_MOVE_1] = gText_EasyChatGroupName_Move1,
    [EC_GROUP_MOVE_2] = gText_EasyChatGroupName_Move2,
    [EC_GROUP_TRENDY_SAYING] = gText_EasyChatGroupName_TrendySaying,
    [EC_GROUP_POKEMON_2] = gText_EasyChatGroupName_Pokemon2,
};
