...
} const sCursorOptions[] =
{
	...
	[MENU_SUMMARY + 31] = {gText_Summary5Spa, CursorCB_Summary},
    [MENU_SWITCH + 31] = {gText_Switch2Spa, CursorCB_Switch},
    [MENU_CANCEL1 + 31] = {gText_SSCancelSpa, CursorCB_Cancel1},
    [MENU_ITEM + 31] = {gText_ItemSpa, CursorCB_Item},
    [MENU_GIVE + 31] = {gText_GiveSpa, CursorCB_Give},
    [MENU_TAKE_ITEM + 31] = {gText_TakeSpa, CursorCB_TakeItem},
    [MENU_MAIL + 31] = {gText_MailSpa, CursorCB_Mail},
    [MENU_TAKE_MAIL + 31] = {gText_Take2Spa, CursorCB_TakeMail},
    [MENU_READ + 31] = {gText_Read2Spa, CursorCB_Read},
    [MENU_CANCEL2 + 31] = {gText_SSCancelSpa, CursorCB_Cancel2},
    [MENU_SHIFT + 31] = {gText_ShiftSpa, CursorCB_SendMon},
    [MENU_SEND_OUT + 31] = {gText_SendOutSpa, CursorCB_SendMon},
    [MENU_ENTER + 31] = {gText_EnterSpa, CursorCB_Enter},
    [MENU_NO_ENTRY + 31] = {gText_NoEntrySpa, CursorCB_NoEntry},
    [MENU_STORE + 31] = {gText_StoreSpa, CursorCB_Store},
    [MENU_REGISTER + 31] = {gText_RegisterSpa, CursorCB_Register},
    [MENU_TRADE1 + 31] = {gText_Trade4Spa, CursorCB_Trade1},
    [MENU_TRADE2 + 31] = {gText_Trade4Spa, CursorCB_Trade2},
    [MENU_FIELD_MOVES + FIELD_MOVE_FLASH + 31] = {gMoveNamesSpa[MOVE_FLASH], CursorCB_FieldMove},
    [MENU_FIELD_MOVES + FIELD_MOVE_CUT + 31] = {gMoveNamesSpa[MOVE_CUT], CursorCB_FieldMove},
    [MENU_FIELD_MOVES + FIELD_MOVE_FLY + 31] = {gMoveNamesSpa[MOVE_FLY], CursorCB_FieldMove},
    [MENU_FIELD_MOVES + FIELD_MOVE_STRENGTH + 31] = {gMoveNamesSpa[MOVE_STRENGTH], CursorCB_FieldMove},
    [MENU_FIELD_MOVES + FIELD_MOVE_SURF + 31] = {gMoveNamesSpa[MOVE_SURF], CursorCB_FieldMove},
    [MENU_FIELD_MOVES + FIELD_MOVE_ROCK_SMASH + 31] = {gMoveNamesSpa[MOVE_ROCK_SMASH], CursorCB_FieldMove},
    [MENU_FIELD_MOVES + FIELD_MOVE_WATERFALL + 31] = {gMoveNamesSpa[MOVE_WATERFALL], CursorCB_FieldMove},
    [MENU_FIELD_MOVES + FIELD_MOVE_TELEPORT + 31] = {gMoveNamesSpa[MOVE_TELEPORT], CursorCB_FieldMove},
    [MENU_FIELD_MOVES + FIELD_MOVE_DIG + 31] = {gMoveNamesSpa[MOVE_DIG], CursorCB_FieldMove},
    [MENU_FIELD_MOVES + FIELD_MOVE_MILK_DRINK + 31] = {gMoveNamesSpa[MOVE_MILK_DRINK], CursorCB_FieldMove},
    [MENU_FIELD_MOVES + FIELD_MOVE_SOFT_BOILED + 31] = {gMoveNamesSpa[MOVE_SOFT_BOILED], CursorCB_FieldMove},
    [MENU_FIELD_MOVES + FIELD_MOVE_SWEET_SCENT + 31] = {gMoveNamesSpa[MOVE_SWEET_SCENT], CursorCB_FieldMove},
    [MENU_FIELD_MOVES + FIELD_MOVE_DIVE + 31] = {gMoveNames[MOVE_DIVE], CursorCB_FieldMove},
};
...
} const sFieldMoveCursorCallbacks[] =
{
    ...
    [FIELD_MOVE_DIVE + 13]         = {SetUpFieldMove_Dive,        PARTY_MSG_CANT_USE_HERE},
};
