...
static const u8 sText_Trainer2ClassSpa[] = _("{B_TRAINER2_LOSE_TEXT}");
...
static const u8 sText_Trainer2NameSpa[] = _("{B_TRAINER2_WIN_TEXT}");
static const u8 sText_PkmnGainedEXPSpa[] = _("¡{B_BUFF1} ganó {B_BUFF3}\npuntos de EXP.{B_BUFF2}!\p");
...
static const u8 sText_PkmnWasDefrostedBySpa[] = _("¡{B_CURRENT_MOVE} descongeló\na {B_ATK_NAME_WITH_PREFIX}!");
...
static const u8 sText_PkmnRaisedSpDefSpa[] = _("¡{B_CURRENT_MOVE} de POKéMON\n{B_ATK_PREFIX2} subió la DEF. ESP.!");
static const u8 sText_PkmnRaisedSpDefALittleSpa[] = _("¡{B_CURRENT_MOVE} de POKéMON\n{B_ATK_PREFIX2} subió algo DEF. ESP.!");
static const u8 sText_PkmnRaisedDefSpa[] = _("¡{B_CURRENT_MOVE} de POKéMON\n{B_ATK_PREFIX2} subió la DEFENSA!");
static const u8 sText_PkmnRaisedDefALittleSpa[] = _("¡{B_CURRENT_MOVE} de POKéMON\n{B_ATK_PREFIX2} subió algo DEFENSA!");
static const u8 sText_PkmnCoveredByVeilSpa[] = _("¡POKéMON {B_ATK_PREFIX2} se \nprotegió con VELO SAGRADO!");
...
static const u8 sText_SpikesScatteredSpa[] = _("¡El equipo POKéMON {B_DEF_PREFIX1}\nha sido rodeado de PÚAS!");
...
static const u8 sText_EmptyString5Spa[] = _("");
...
static const u8 sText_Trainer1SentOutTwoPkmnSpa[] = _("¡{B_OPPONENT_MON2_NAME} y {B_OPPONENT_MON1_NAME} son la\nopción de {B_TRAINER1_CLASS} {B_TRAINER1_NAME}!{PAUSE 60}");
...
static const u8 sText_AccuracySpa[] = _("PRECISIÓN");
...
static const u8 sText_BerrySuffixSpa[] = _("BAYA {B_COPY_VAR_3}");
...
const u8 gText_CongratsPkmnEvolvedSpa[] = _("¡Enhorabuena! ¡Tu {B_COPY_VAR_1}\nse ha convertido en {B_COPY_VAR_2}!{WAIT_SE}\p");
...
const u8 gText_BattleMenuSpa[] = _("{FONT_SMALL}{PALETTE 5}{COLOR_HIGHLIGHT_SHADOW 13 14 15}LUCHA{CLEAR_TO 56}MOCHILA\nPOKéMON{CLEAR_TO 56}HUIDA{FONT_NORMAL_COPY_1}");
...
const u8 gText_BattleTextPrefixSpa[] = _("{PALETTE 5}{COLOR_HIGHLIGHT_SHADOW 13 14 15}");
...
const u8 gText_83FE7C7Spa[] = _("{FONT_SMALL}PS{FONT_NORMAL} máx.");
...
//Spanish
const u8 gText_SafariBallsSpa[] = _("{HIGHLIGHT 2}SAFARI BALLS");
...
const u8 gText_ClearTimeSpa[] = _("TIEMPO");
const u8 gText_XMinYZSecSpa[] = _("{B_COPY_VAR_1} min {B_COPY_VAR_2},{B_COPY_VAR_3} s");
...
//SPANISH
const u8 gText_83FE9D4Spa[] = _("¡{B_TRAINER1_CLASS} {B_TRAINER1_NAME} ha huido!");
static const u8 sText_PlayerLostAgainstTrainer1Spa[] = _("¡Has perdido contra\n{B_TRAINER1_CLASS} {B_TRAINER1_NAME}!");
static const u8 sText_PlayerBattledToDrawTrainer1Spa[] = _("¡{B_TRAINER1_CLASS} {B_TRAINER1_NAME} ha\nempatado contigo!");
