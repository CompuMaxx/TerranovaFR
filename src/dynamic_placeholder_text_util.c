...
static const u8 sTextColorTable[] =
{
 // [LOW_NYBBLE / 2]                            = 0xXY, // HIGH_NYBBLE
    ...
    [OBJ_EVENT_GFX_GAMER / 2]               = 0x00, // OBJ_EVENT_GFX_OLD_MAN_1
    [OBJ_EVENT_GFX_OLD_MAN_LYING_DOWN / 2]      = 0x10, // OBJ_EVENT_GFX_OLD_WOMAN_1
    [OBJ_EVENT_GFX_TUBER_M_WATER / 2]           = 0x10, // OBJ_EVENT_GFX_TUBER_F_LAND
    ...
    [OBJ_EVENT_GFX_UNION_ROOM_RECEPTIONIST / 2] = 0x01, // OBJ_EVENT_GFX_CAMERAMAN
